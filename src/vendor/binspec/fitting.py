...
# El-Badry et al. 2018b. Copied verbatim; the ONLY edits are the two import
# lines `import spectral_model` / `import utils` -> `from . import ...` so they
# resolve their siblings inside this package (REQUIREMENT: intra-package
# imports, no /tmp/binspec). The curve_fit multi-start, the single-star and
# binary fits, and the single-star fallback guard are all unchanged.
# ===========================================================================
