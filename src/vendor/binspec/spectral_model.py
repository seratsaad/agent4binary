...
# El-Badry et al. 2018b. Copied verbatim; the ONLY edit is the import line
# `import utils` -> `from . import utils` so the module resolves its sibling
# inside this package (REQUIREMENT: intra-package imports, no /tmp/binspec).
# The forward models (single-star and binary), the R^2 flux scaling, the
# q -> (Teff2, logg2) isochrone net, and the radius net are all unchanged.
# ===========================================================================
